...
export const adminApi = {
  ...
  updateOrderStatus: (ticketId, data) => axios.put(`/api/admin/pesanan/${ticketId}/status`, data).then(res => res.data),
  ...
  deleteOrder: (ticketId) => axios.delete(`/api/admin/orders/${ticketId}`).then(res => res.data),
  ...
  getAdmin: (id) => axios.get(`/api/admin/admins/${id}`).then(res => res.data),
  createAdmin: (data) => axios.post('/api/admin/admins', data).then(res => res.data),
  updateAdmin: (id, data) => axios.put(`/api/admin/admins/${id}`, data).then(res => res.data),
